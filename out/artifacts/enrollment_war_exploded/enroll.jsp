    ...
    <div class="container">
        ...
        <%
            ...
            if(id != null && term != null && year != null) {
                enroll.getStudent(id,term,year);
                isEmpty = false;
            }
        %>
        ...
        <% if(!isEmpty) { %>
            <div class="row mt-4">
                ...
                <h3 class="col-4"><%=enroll.Student.studentid%></h3>
            </div>
            <div class="row">
                <h3 class="col-4">Student Name</h3>
                <h3 class="col-4"><%=enroll.Student.completename%></h3>
            </div>
            <div class="row">
                <h3 class="col-4">Student Degree</h3>
                <h3 class="col-4"><%=enroll.Student.degreeid%></h3>
            </div>
        ...
        <table class="table">
            ...
            <tbody>
            <%
                int len = enroll.EnrollmentList.size();
                for(int i=0; i < len; i++) {
                    enrollment en = enroll.EnrollmentList.get(i);
            %>
            <tr>
        ...
        <h2 class="my-3">Check subjects you want to enroll</h2>

        <form action="doenroll.jsp" method="post" class="mb-4">
            <%
                len = enroll.CourseList.size();
                for(int i=0; i < len; i++) {
